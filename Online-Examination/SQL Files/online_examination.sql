...
(4, 'c quiz', '2019-11-18 16:13:50', 'venkateshbhat27@gmail.com'),
...
CREATE TRIGGER `remarks` BEFORE INSERT ON `score`
 FOR EACH ROW set NEW.remark = if(NEW.score <= 1, 'bad', 'good')
//
DELIMITER ;
...
('svit1', 'B G VINAYAK', 'BHATVINAYAK94@GMAIL.COM', '9740834260', 'M', '1999-09-23', 'ral7gku4rfhLk', 'MEC'),
('123', 'Rakesh M R', 'rakeshmr723@gmail.com', '9901735897', 'M', '1999-10-07', 'rajJYeVNCiGD2', 'ECE'),
('456','Venkatesh Bhat','venkateshbhat27@gmail.com','9902417238','M','2000-01-04','as12df34gh56','CSE');
...
('4MW20ME001', 'B G VINAYAK', 'BHATVINAYAK94@GMAIL.COM', '9740834260', 'M', '1999-09-23', 'ral7gku4rfhLk', 'MEC'),
('4MW20CS002', 'Rakesh Mariyaplar', 'rakeshmariyaplar1@gmail.com', '6360300095', 'M', '1999-10-07', 'rajJYeVNCiGD2', 'CSE'),
('4MW20ECE111', 'Rakesh M R', 'rakeshmr723@gmail.com', '9901735897', 'M', '2000-10-07', 'rajJYeVNCiGD2', 'ECE'),
('4MW20CV003', 'Siddhanth Sipoliya', 'siddhanthsipoliya@saividya.ac.', '7619360459', 'M', '1999-11-15', 'ray.whoA8HjCQ', 'CIV'),
('4MW20CS102','Venkatesh Bhat','venkateshbhat27@gmail.com','9902417238','M','2000-01-04','zx12cv34bn56','CSE');
