...
<body style="margin: 0 !important;font-weight: bolder !important;background-image:url(./images/dark.png);font-family: 'Courier New', Courier, monospace;height:auto;color:#fff">
    <div id="main" style="height: auto;color:#fff !important">
        ...
        <center><section style="width:100vw;margin:0vw;margin-top:4vw;font-size:2vw;">Welcome&nbsp;<?php echo $dbname ?></section></center>
           ...
           <center>
            <section id="addq" style="display:none;">
                <form style="width: 30vw" method="post">
                        ...
                        <input class="ip1" type="submit" name="submit" value="submit">
            ...
            <section id="delq" style="display:none;">
                <form style="margin: 1vw;width: 30vw" method="post">
                        ...
                        <input class="ip1" type="submit" name="submit1" value="submit">
            ...
            <section id="viewq" style="display:none;">
                <form style="margin: 1vw;width: 30vw" method="post">
                        ...
                        <h1>View Quiz</h1>
                        <input type="number" name="quizid" placeholder="enter quiz id" required><br><br>
                        <input class="ip1" type="submit" name="submit2" value="submit" style="margin-right:5vw;">
