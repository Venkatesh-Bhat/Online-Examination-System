...
// require_once 'sql.php';
                $conn = mysqli_connect("localhost","root","","online_examination");if (!$conn) {
            ...
            <section id="ans">
                <center>
                    <form style="margin: 0vw;width: 100vw" method="post">
                        ...
                        <input type="submit" name="submit" value="add 1 more question" class="ip1">
                        <input type="submit" name="submit1" value="Done" class="ip1">
                    </form>
                </center>
            </section>
        </section>
